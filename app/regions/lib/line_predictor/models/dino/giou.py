...
def get_area_from_corners(corners):
    """calculate area of a polygon
    Args:
        corners (torch.Tensor): (B, N, 4, 2)
    Returns:
        torch.Tensor: (B, N) area
    """
    x1 = corners[..., 0, 0]
    y1 = corners[..., 0, 1]
    x2 = corners[..., 1, 0]
...
def cal_iou(corners1: torch.Tensor, corners2: torch.Tensor):
    """calculate iou
    ...
    area1 = get_area_from_corners(corners1)
    area2 = get_area_from_corners(corners2)
    u = area1 + area2 - inter_area
    iou = inter_area / u
    return iou, corners1, corners2, u


def cal_giou(corners1, corners2):
    iou, corners1, corners2, u = cal_iou(corners1, corners2)
