...
def gen_encoder_output_proposals(memory:Tensor, memory_padding_mask:Tensor, spatial_shapes:Tensor, learnedwh=None):
    ...
    for lvl, (H_, W_) in enumerate(spatial_shapes):
        ...
        proposal = torch.cat((grid, grid,grid,grid,grid,grid,grid,grid,grid,grid), -1).view(N_, -1, 20)
...
def gen_sineembed_for_position(pos_tensor):
    ...
    if pos_tensor.size(-1) == 2:
        ...
        pos = torch.cat((pos_y, pos_x, pos_y, pos_x,pos_y,  pos_x,pos_y,  pos_x,pos_y, pos_x, pos_y, pos_x, pos_y, pos_x, pos_y, pos_x, pos_y, pos_x, pos_y, pos_x), dim=2)
    else:
